...
const sniperShot = [
    {
        ...
        offset: {x: 0, y: 0},
        style: {
            fill: 'rgba(255, 150, 100, 1)',
            stroke: {colour: 'rgba(230, 135, 90, 1)', width: 2},
        },
    },
];
        ...
        player: {
            ...
            upgrades: [
                ...
                },
                {
                    ...
                    locked: false,
                    cost: 250, 
                    increment: {cost: 9750, mode: 'addition'}
                },
            ],
        },
        physics: {
...
function levelSTDV1() {
    ...
    for (let i = 0; i < 2; i++) {
        basicEnemy.x = randint(1000, 2000);
        basicEnemy.y = randint(1000, 2000);
        if (randchoice([0,1])) {
            basicEnemy.x *= -1;
        }
        if (randchoice([0,1])) {
    ...
    for (let i = 0; i < 2; i++) {
        shootingEnemy.x = randint(1000, 2000);
        shootingEnemy.y = randint(1000, 2000);
        if (randchoice([0,1])) {
            shootingEnemy.x *= -1;
        }
        if (randchoice([0,1])) {
    ...
    for (let i = 0; i < 1; i++) {
        fastEnemy.x = randint(1000, 2000);
        fastEnemy.y = randint(1000, 2000);
        if (randchoice([0,1])) {
            fastEnemy.x *= -1;
        }
        if (randchoice([0,1])) {
    ...
    for (let i = 0; i < 2; i++) {
        gunEnemy.x = randint(1000, 2000);
        gunEnemy.y = randint(1000, 2000);
        if (randchoice([0,1])) {
            gunEnemy.x *= -1;
        }
        if (randchoice([0,1])) {
